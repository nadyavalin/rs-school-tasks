    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Куркума - желтый порошок, используемый в кулинарии",
          id: 1833,
          word: "powder",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Толпа, казалось, присоединилась к протестующим",
          id: 1841,
          word: "align",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Полиции пришлось задержать вора за кражу в магазине",
          id: 1848,
          word: "detain",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Когда хищник приближается к оленю, олень убежит",
          id: 1851,
          word: "flee",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "Эти студенты получают образование в частной школе",
          id: 1862,
          word: "education",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Джастин столкнется со многими проблемами на работе",
          id: 1866,
          word: "face",
          wordTranslate: "лицо",
        },
        ...
        },
        {
          ...
          textExampleTranslate:
            "Г-жа Смит дала ценные советы всем своим ученикам",
          id: 1869,
          word: "guidance",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "Родители обязаны воспитывать своих детей с любовью",
          id: 1876,
          word: "responsibility",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Навыки презентации - важный инструмент для общения",
          id: 1878,
          word: "tool",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Игрушечные машины доступны во множестве цветов",
          id: 1883,
          word: "array",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Фотограф может размыть яркие огни на заднем плане",
          id: 1884,
          word: "blur",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Художник начал с желтого мазка на своей картине",
          id: 1896,
          word: "stroke",
        ...
        },
        {
          ...
          textExampleTranslate:
            "В отличие от своего старшего брата, Джим короткий",
          id: 1899,
          word: "unlike",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Тысячи солдат были готовы мобилизоваться для борьбы",
          id: 1908,
          word: "mobilize",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Индия - это страна, которая быстро развивается",
          id: 1909,
          word: "nation",
          wordTranslate: "нация",
        },
        ...
        },
        {
          ...
          textExampleTranslate:
            "Ученые подготовились к вспышке опасного вируса",
          id: 1911,
          word: "outbreak",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Карен пришлось многим пожертвовать ради своих детей",
          id: 1914,
          word: "sacrifice",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Землетрясение вызвало трещину в нескольких местах",
          id: 1928,
          word: "earthquake",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "Американский журавль является исчезающим видом",
          id: 1929,
          word: "endangered",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Мишель и Таня хотят быть лучшими друзьями навсегда",
          id: 1931,
          word: "forever",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "Она является неотъемлемым членом нашей команды",
          id: 1970,
          word: "integral",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Какая минимальная температура зимой в этом районе?",
          id: 1974,
          word: "minimum",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Мы читаем биографию Чарльза Дарвина на уроке науки",
          id: 2023,
          word: "biography",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Я думал о разных аспектах владения двумя собаками",
          id: 2041,
          word: "aspect",
        ...
        },
        {
          ...
          textExampleTranslate:
            "На плакате не было указано, где проходил концерт",
          id: 2057,
          word: "specify",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "Нить ДНК выглядит как две взаимосвязанные спирали",
          id: 2099,
          word: "spiral",
        ...
        },
        {
          ...
          textExampleTranslate:
            "В книжном магазине работали два штатных клерка",
          id: 2123,
          word: "employ",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Он был пионером компьютерного программирования",
          id: 2149,
          word: "pioneer",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Домино упали в последовательности один за другим",
          id: 2153,
          word: "sequence",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Сервис от менее уважаемой компании разозлил ее",
          id: 2195,
          word: "reputable",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Мы посетили могилы наших умерших бабушек и дедушек",
          id: 2225,
          word: "deceased",
        ...
        },
        {
          ...
          textExampleTranslate:
            "После заката Ханна пошла ловить светлячков в парке",
          id: 2229,
          word: "dusk",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "У плохих парней в большинстве фильмов зловещий смех",
          id: 2238,
          word: "sinister",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Бег без хорошей обуви может вызвать боль в ногах",
          id: 2245,
          word: "induce",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Студенты были собраны на улице и разбиты на группы",
          id: 2275,
          word: "marshal",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Больничная палата выглядела довольно стерильной",
          id: 2317,
          word: "sterile",
      ...
      words: [
        {
          ...
          textExampleTranslate:
            "Перед едой они поблагодарили Всевышнего за пищу",
          id: 2322,
          word: "Almighty",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Яркие мигающие огни могут вызвать судороги у детей",
          id: 2338,
          word: "seizure",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Приглашаем всех посетить мультикультурный праздник",
          id: 2353,
          word: "multicultural",
    ...
    },
    {
      ...
      words: [
        ...
        },
        {
          ...
          textExampleTranslate:
            "Они должны были выбрать учебники для каждого класса",
          id: 2357,
          word: "select",
        ...
        },
        {
          ...
          textExampleTranslate:
            "Визуальные дисплеи были очень привлекательными",
          id: 2359,
          word: "visual",
